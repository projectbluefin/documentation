...
<BlogSeries seriesId="bluefin-spring-2026" currentPart={4} />
...
Thanks to [Jordan Petridis](https://github.com/alateira), [Valentin David](https://github.com/valentindavid), [Adrian Vovk](https://github.com/AdrianVovk), [Felicitas Pojtinger](https://github.com/pojntfx), and the [GNOME OS team](https://os.gnome.org/) for their expertise and advisory roles - we couldn't do this without you!
...
[Colin Walters](https://github.com/cgwalters) describes communities like this as "Centers of Gravity" - and we're all in one gigantic galaxy, everyone pulling and pushing around different ecosystems. All made possible by open source tools, amazing. 
...
I [annoyingly say no to most things](https://www.youtube.com/watch?v=K6-GMTq2T7s&t=2896s), we added this as a sustainability principle so that we wouldn't fall into a trap. [Saying No](https://mikemcquaid.com/saying-no/) is a great resource for this.

But at some point it's so simple to drive buildstream that Ahmed whipped up an impressive prototype already:

We've come to the point where one individual can produce a _consumer grade Linux desktop experience_. A COSMIC desktop built on the freedesktop SDK rocks, of course it does! And there's no "distro trap" here. There's no "Why are you making another one of these? Wasting resources!" because the bulk of the stuff is handled upstream. If this brings one person to fix stuff in the Freedesktop SDK for the entire community, it will be worth it!
