...
Since this is all well designed cloud-native stuff "knuckle + opinion" = Product. Something like on first boot out of the box you get
...
- No CLI, No ssh, or kubectl access at all - entire cluster is API or MCP driven
- Standard industry gear, Kubernetes, Argo Workflows, k8s-mcp-server

Now THAT is an opinion! I have a version of this running in my lab now, and we'll keep iterating, so start with ideas. It's still early days but warm up your homelabs for the summer ...
