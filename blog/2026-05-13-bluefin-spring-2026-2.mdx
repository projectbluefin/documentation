...
We have an Open Source contributor in duress. People will complain about GNOME, but we're an open source project, our job is to help. So we're putting Extensions in GNOME front and center - and we're going to force the issue. People will either step up and help maintain and curate, or they won't. 
