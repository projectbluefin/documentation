...
I'm sure someone will complain about scope. Yes, it is totally hypocritical to say "Packages suck! Throw it all away!" and then add this to Bazaar. There's prior art here, but mostly it's to get something out that's installed on tens of thousands of machines to highlight one thing.

[ Add your favorite complaint about GNOME extensions here. Go ahead and take your time, we'll wait.]

We have an Open Source contributor in duress. People will complain about GNOME, but we're an open source project, our job is to help. So we're putting Extensions in GNOME front and center - and we're going to force the issue. People will either step up and help maintain and curate, or they won't. I've never met J. But if someone is willing to put so much work into something, we have no choice but to help. Also, remember, you think YOU hate the GNOME Extensions situation, how do you think maintainers feel? So we hope to shed some light on an area that needs attention. 

Full disclosure, I donated for this feature to be implemented because if there is to be a future of an extensible, sustainable GNOME then we need to find it. 
