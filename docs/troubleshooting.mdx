...
For local models, [Ramalama](https://github.com/containers/ramalama) is the recommended option. It manages models as containers and serves an OpenAI-compatible endpoint that Goose reaches via the `ollama` provider:
