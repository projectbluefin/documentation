...
**Step 3: Add Dosu (optional)**

[Dosu](https://dosu.dev) gives the agent access to your knowledge base and documentation. Each user authenticates with their own account:
...
`dosu mcp add goose` writes the Dosu extension entry into `~/.config/goose/config.yaml` automatically.
