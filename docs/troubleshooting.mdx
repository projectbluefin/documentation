...
For local models, [LM Studio](https://lmstudio.ai/) and [Ramalama](https://github.com/containers/ramalama) both serve an OpenAI-compatible endpoint that Goose can point at — available from `ujust bbrew` → `ai`:

| Tool | Install | Endpoint |
| ---- | ------- | -------- |
| LM Studio | `brew install ublue-os/tap/lm-studio-linux` | `http://localhost:1234` |
| Ramalama | `brew install ramalama` | `http://localhost:8080` |
