...
import LtsDownloadCard from "@site/src/components/LtsDownloadCard";
...
- The same packages of Bluefin, but built with CentOS Stream 10 and EPEL
...
- Updated, but gated Linux kernel from Fedora with secure boot enabled
...
![Pasted image](/img/user-attachments/3972ac0f-d37e-4e89-ae91-ff1eb76eabeb.png)
...
Known issues and tracking are documented on [GitHub Issues](https://github.com/projectbluefin/bluefin-lts/issues).
